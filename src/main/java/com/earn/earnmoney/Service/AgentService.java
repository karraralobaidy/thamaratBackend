...
public interface AgentService {
    ...
    Agent registerAgent(String name, String phone, String whatsapp, String telegram, String facebook, String instagram,
    ...
    Agent updateAgent(Long id, String name, String phone, String whatsapp, String telegram, String facebook,
            String instagram, org.springframework.web.multipart.MultipartFile file) throws java.io.IOException;
