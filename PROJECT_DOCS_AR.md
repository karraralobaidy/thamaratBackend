# توثيق مشروع Dananerk-BackEnd (دنانيرك)

## نظرة عامة
**Dananerk-BackEnd** هو تطبيق يعتمد على إطار عمل Spring Boot ويعمل كواجهة خلفية (Backend) لمنصة "حلال" / "اربح مالاً". يتيح التطبيق للمستخدمين كسب النقاط من خلال آلية "العداد"، مشاهدة الإعلانات، شراء بطاقات رقمية، وسحب الأرباح.
